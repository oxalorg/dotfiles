...
Corgi is a debundled emacs configuration. Which is absolutely awesome, because it lets you choose only the packages you want.

For example, I include almost all the corgi packages except for =corgi-defaults= and =corgi-editor=. I want those to be configured in my own way.
...
#+RESULTS:
| smartparens-mode | hs-minor-mode | rainbow-delimiters-mode | company-mode |
...
#+RESULTS:
| hs-minor-mode | rainbow-delimiters-mode | company-mode | smartparens-mode |
