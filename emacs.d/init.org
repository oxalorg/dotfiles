...
#+RESULTS:
: error in evil-define-key: Symbol’s value as variable is void: evil-magit-state
...
#+RESULTS:
| er/add-js2-mode-expansions | evil-collection-js2-set-evil-shift-width | js2-imenu-extras-mode | er/add-js-mode-expansions |
